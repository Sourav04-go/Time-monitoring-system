...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">TIME TABLE MANAGEMENT SYSTEM, COMPUTER SCIENCE ENGINEERING, NITK</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/building.png" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/cs.jpg" alt="Chania">
        </div>
        ...
        <div class="item">
            <img src="assets/img/lab2.png" alt="Flower">
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/diRECTOR.jpg" class="img-rounded"/>
                    <h3 align="center">Prof. Karanam Umamaheshwar Rao</h3>
                    <hr/>
                    <h4 align="center">Director<br/> National institute of technology karnataka</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="assets/img/hod.jpg" class="img-rounded"/>
                    <h3 align="center">Shashidhar G Koolagudi</h3>
                    <hr/>
                    <h4 align="center">Associate Professor & Head of the Department<br/> Computer Science Engineering</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/Professor.jpg" class="img-rounded"/>
                    <h3 align="center">Annappa B</h3>
                    <hr/>
                    <h4 align="center">Professors<br/>Computer Engineering Department</h4>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4>India - 575 014</h4>
                <h4><strong>Call:</strong> 0824 2474000 </h4>
                <h4><strong>Email: </strong>registrar@nitk.ac.in</h4>
            </div>
